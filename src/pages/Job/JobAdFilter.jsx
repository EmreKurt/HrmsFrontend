...
export default function JobAdFilter({ clickEvent }) {
  ...
  useEffect(() => {
      ...
      workTypeService.getWorkType().then(result => setWorkPlaces(result.data.data))
  ...
  return (
      <div>
          ...
          <Button
              ...
              fluid
              color="green"
              onClick={() => clickEvent({ cityId: cityIndex, positionId: jobPositionIndex, workTypeId: workPlaceIndex, workTimeId: workTimeIndex})}
          >
              Filtrele
          </Button>
      </div>
